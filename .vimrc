...
"" Disable backup and swap file, useless
set nobackup
set nowritebackup
set noswapfile
...
autocmd!
autocmd FileType python setlocal autoindent noexpandtab shiftwidth=8 tabstop=8 colorcolumn=1000
...
hi Search cterm=underline,bold ctermfg=223 ctermbg=NONE
let g:lightline = {}
